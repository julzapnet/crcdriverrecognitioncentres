 ...
 */
package com.driverrecognitioncentres.product.controller;

import com.driverrecognitioncentres.product.entities.Product;
import com.driverrecognitioncentres.product.repository.ProductRepository;
...
public class ProductRestController {
    ...
    public ResponseEntity<?> put(@PathVariable(name = "id") long id, @RequestBody Product input) {
        ...
        if (product.isPresent()){
            ...
            newProduct.setStatus(input.getStatus());
